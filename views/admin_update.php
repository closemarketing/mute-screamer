...
<?php
	...
	<tr class='active'>
		...
		<td class='plugin-title'><strong>{$file}</strong>" . sprintf(__('Update to revision %1$s. <a href="%2$s">Review changeset</a>.', 'mute-screamer'), $file_data->revision, $file_data->revision_url) . "</td>
	</tr>";
	}
?>
	</tbody>
